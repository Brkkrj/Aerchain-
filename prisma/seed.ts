...
async function main() {
  ...
  const vendors = [
    ...
    { id: "V4", name: "Sri Ranga Aggregates", suppliesCategories: ["Aggregate"], serviceLocations: ["Pune"], capacityUomPerMonth: 80, dealsLast30Days: 15, replyChannel: "telegram", email: "sachdeva351@gmail.com", telegramPhone: ALT_PHONE },
